...
WebUI.callTestCase(findTestCase('Pages/UserRegister/Input Nama'), [('nama') : 'Afi Sherma Ranita'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/UserRegister/Input Email Address'), [('email') : 'pltnmchllgn08@yopmail.com'], FailureHandling.STOP_ON_FAILURE)
