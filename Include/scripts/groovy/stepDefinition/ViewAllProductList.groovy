...
class ViewAllProductList {
	...
	@Then("User click list menu button")
	public void user_click_list_menu_button() {
		WebUI.callTestCase(findTestCase('Pages/UserAddItem(Daftar Jual)/Click Menu Button'), [:], FailureHandling.STOP_ON_FAILURE)
	}
	
	@Then("User can see all product list")
	public void user_can_see_all_product_list() {
